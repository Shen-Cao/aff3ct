...
namespace module
{
	namespace dec
	{
		enum class tsk : size_t { decode_hiho, decode_hiho_cw, decode_siho, decode_siho_cw, decode_siso, decode_siso_alt, set_crc_const, decode_siho_cw_flexible_frozen, set_known_bits, SIZE };
		...
		namespace sck
		{
			...
			enum class set_known_bits  : size_t { KNOWN_BITS         , status };
		}
